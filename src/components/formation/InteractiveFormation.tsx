...
import { BookOpen, CheckCircle, Clock, Users, Play } from 'lucide-react';
import { useTrainingModules } from '@/hooks/useTrainingModules';
import { useTrainingProgress, useModuleCompletion } from '@/hooks/useTrainingProgress';
import { Skeleton } from '@/components/ui/skeleton';
import { InteractiveModuleViewer } from './InteractiveModuleViewer';

export const InteractiveFormation = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Apprenez la production de fourrage hydroponique à travers des modules interactifs 
